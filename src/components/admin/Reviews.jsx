...
const Reviews = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get("https://air2ca.onrender.com/admin/comments");
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (selectedRecord) {
        await axios.put(`https://air2ca.onrender.com/update-comments/${selectedRecord.id}`, values);
      } else {
        await axios.post("https://air2ca.onrender.com/admin/add-comment", values);
      }
  ...
  const handleDelete = async (record) => {
    try {
      await axios.delete(`https://air2ca.onrender.com/admin/delete-comments/${record.id}`);
      setLoading(true);
      fetchReviews();
    } catch (error) {
