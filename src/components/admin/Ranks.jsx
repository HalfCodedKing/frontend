...
const Ranks = () => {
  ...
  const fetchRecords = async () => {
    try {
      const response = await axios.get("https://air2ca.onrender.com/admin/records");
  ...
  const sendAddRecordRequest = async (formData) => {
    try {
      if (selectedRecord) {
        ...
        await axios.put(`https://air2ca.onrender.com/admin/update-record/${selectedRecord.id}`, formData, {
          headers: {
        ...
        await axios.post("https://air2ca.onrender.com/admin/add-record", formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        });
  ...
  const handleDelete = async (record) => {
    try {
      ...
      await axios.delete(`https://air2ca.onrender.com/admin/delete-record/${record.id}`);
      setLoading(true); // Set loading to true before refetching records
